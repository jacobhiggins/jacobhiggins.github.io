...
The worst gift would be a crystal ball that is sometimes right, sometimes wrong. In fact, you're intuition might be telling you that the worst case scenario is a crystal ball that is correct only $50\%$ of the time, and you would be right. Think about it: if the crystal ball was, say, $90\%$ correct, then you know that an average you could trust what it tells you. But if the crystal ball was right only half the time, then you wouldn't be able to tell at all if it will rain that day, not even on average. In other words, the crystal ball that has $P(correct)=P(incorrect)=0.5$ cannot reliably give you any information.
