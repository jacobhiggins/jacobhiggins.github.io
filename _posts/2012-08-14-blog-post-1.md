...
One simple way to address this problem is by setting the discount factor $ \gamma\le 1$. Suppose we perform the same algorithm outlined above, but instead make this change. The resulting optimal value function would look like:
