...
Inside the starter code folder, let's look at the vi_and_pi.py file; this is where you'll add the code to make everything run.

Inside the main function down at the end of the file, you'll find the following code:
