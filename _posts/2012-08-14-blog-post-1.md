...
In order to show what this algorithm does, lets look at a simple example. Below is a 1D world comprised of seven squares. Our player starts in the center of the world, square four. Our goal is to reach the rightmost square seven, and avoid the leftmost square one.
