...
Below are the completed policy_evaluation and policy_improvement functions. The code is commented well enough so that what is happening should be clear.
...
When you run this code, each iteration will produce a policy and value function that converges to the optimum. Below is the evolution of the proposed value function over each iteration:
